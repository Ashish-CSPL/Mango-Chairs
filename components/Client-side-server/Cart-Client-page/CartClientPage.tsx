        ...
        {cartItems.length === 0 ? (
          ...
          <>
            ...
            <div className="mt-8 bg-white p-4 sm:p-6 rounded-lg shadow-md text-sm text-gray-700">
              ...
              <p className="mb-2">
                Any orders placed after 10pm Friday and over the weekend will
                not be dispatched until Monday, excluding Public Holidays.
              </p>
              <p className="mb-2">
              ...
              <p className="text-xs">
                ...
                playhouses) will be delivered in their original packing which
                may display images or details of the contents.
              </p>
            </div>
          </>
        )}
